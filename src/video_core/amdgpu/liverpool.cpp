    ...
    while (!acb.empty()) {
        ...
        case PM4ItOpcode::Rewind: {
            ...
            if (must_flush) {
                ...
                // All GPU modified regions in the command list are patched with indirect dispatches.
                // There is no needed to flush GPU data to CPU so avoiding read protecting pages.
