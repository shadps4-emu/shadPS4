...
// Keys
static ConfigEntry<string> trophyKey{};
...
void load(const std::filesystem::path& path, bool is_game_specific) {
    ...
    if (data.contains("Keys")) {
        ...
        trophyKey = toml::find_or<string>(keys, "TrophyKey", trophyKey.get());
    }
...
void save(const std::filesystem::path& path, bool is_game_specific) {
    ...
    trophyKey.setTomlValue(data, "Keys", "TrophyKey", is_game_specific);
    ...
    if (!is_game_specific) {
        ...
        data["General"]["fontsPath"] = fonts_path.string();
        data["GUI"]["installDirs"] = install_dirs;
        data["GUI"]["installDirsEnabled"] = install_dirs_enabled;
        data["GUI"]["saveDataPath"] = save_data_path.string();
        data["GUI"]["addonInstallDir"] = settings_addon_install_dir.string();
        data["Debug"]["ConfigVersion"] = config_version;
        data["Keys"]["TrophyKey"] = trophyKey.get();
