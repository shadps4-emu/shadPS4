...
void SettingsDialog::updateNoteTextEdit(const QString& elementName) {
    ...
    if (elementName == "graphicsAdapterGroupBox") {
        ...
        text = tr("Vblank Frequency:\\nThe frame rate at which the emulator refreshes at. Changing this may have adverse effects, such as increasing the game speed, or breaking critical game functionality that does not expect this to change!");
