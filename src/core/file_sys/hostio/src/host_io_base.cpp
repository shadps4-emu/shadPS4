...
s64 HostIO_Base::ReadV(s32 fd, const OrbisKernelIovec* iov, s32 iovcnt) { STUB(); }
s64 HostIO_Base::PReadV(s32 fd, const OrbisKernelIovec* iov, s32 iovcnt,
                        s64 offset) { STUB(); }
...
s64 HostIO_Base::WriteV(s32 fd, const OrbisKernelIovec* iov, s32 iovcnt) { STUB(); }
s64 HostIO_Base::PWriteV(s32 fd, const OrbisKernelIovec* iov, s32 iovcnt,
                         s64 offset) { STUB(); }
