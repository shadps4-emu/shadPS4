...
private:
    ...
    public:
        ...
        s32 Open(const fs::path& path, int flags, u16 mode) override;
        s32 Creat(const fs::path& path, u16 mode) override;
        ...
        s64 ReadV(s32 fd, const Libraries::Kernel::OrbisKernelIovec* iov, s32 iovcnt) override;
        s64 PReadV(s32 fd, const Libraries::Kernel::OrbisKernelIovec* iov, s32 iovcnt,
                   s64 offset) override;

        s64 Write(s32 fd, const void* buf, u64 count) override;
        s64 PWrite(s32 fd, const void* buf, u64 count, s64 offset) override;
        s64 WriteV(s32 fd, const Libraries::Kernel::OrbisKernelIovec* iov, s32 iovcnt) override;
        s64 PWriteV(s32 fd, const Libraries::Kernel::OrbisKernelIovec* iov, s32 iovcnt,
                    s64 offset) override;
