...
struct DistortionEngine {
    DistortionEngine(Core::Loader::SymbolsResolver* sym);
};

struct ReprojectionEngine {
    ReprojectionEngine(Core::Loader::SymbolsResolver* sym);
};

struct Engine {
    DistortionEngine m_distortion_engine;
    ReprojectionEngine m_reprojection_engine;
