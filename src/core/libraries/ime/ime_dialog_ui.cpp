...
using Libraries::Ime::ApplyAxisDeadzone;
...
using Libraries::Ime::kNavAxisThreshold;
using Libraries::Ime::kPanelEdgeWrapHoldDelaySec;
using Libraries::Ime::kRepeatIntentWindowSec;
using Libraries::Ime::kStickNavInitialDelayFast;
using Libraries::Ime::kStickNavInitialDelaySlow;
using Libraries::Ime::kStickNavRepeatFast;
using Libraries::Ime::kStickNavRepeatSlow;
using Libraries::Ime::ReadVirtualPadSnapshot;
using Libraries::Ime::RejectInputCharByUtf16Limit;
using Libraries::Ime::ResolveStickNavDirection;
using Libraries::Ime::StickNavDirection;
using Libraries::Ime::Utf16CountFromUtf8Range;
using Libraries::Ime::Utf8ByteIndexFromUtf16Index;
using Libraries::Ime::VirtualLeftStickDirections;
...
void ImeDialogUi::Draw() {
    ...
    if (Begin("IME Dialog##ImeDialog", nullptr, window_flags)) {
        ...
        auto draw_selector = [&](ImVec2 pos, ImVec2 size, bool selected,
            ...
            const float alpha = Libraries::Ime::UpdateImeSelectorFadeAlpha(
            ...
            Libraries::Ime::DrawImeSelectorFrame(
                selector_draw, sel_min, sel_size, selector_corner_radius, kSelectorOverlayColor,
                kSelectorBorderColor, kSelectorBorderThickness, alpha);
        };
        ...
        Libraries::Ime::ResizeImeKeyboardSelectorFade(selector_fade_state, keyboard_rows,
                                                      keyboard_cols);
