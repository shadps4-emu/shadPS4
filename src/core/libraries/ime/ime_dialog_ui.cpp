...
using Libraries::Ime::IsStickDirectionEdgePressed;
using Libraries::Ime::kPanelEdgeWrapHoldDelaySec;
using Libraries::Ime::kRepeatIntentWindowSec;
using Libraries::Ime::ProcessRepeatButton;
using Libraries::Ime::ProcessStickNavPulse;
...
using Libraries::Ime::StickNavPulseResult;
using Libraries::Ime::StickNavPulseState;
using Libraries::Ime::Utf16CountFromUtf8Range;
using Libraries::Ime::Utf8ByteIndexFromUtf16Index;
using Libraries::Ime::VirtualButtonRepeatResult;
...
void ImeDialogUi::Draw() {
    ...
    if (Begin("IME Dialog##ImeDialog", nullptr, window_flags)) {
        ...
        const auto open_main_menu = [&]() {
            ...
            edit_menu_index = 0;
            Libraries::Ime::DisarmMenuActivate(menu_activate_armed);
        };
        ...
        if (edit_menu_popup != EditMenuPopup::None) {
            ...
            Libraries::Ime::RearmMenuActivateOnRelease(cross_down, menu_activate_armed);
            const bool menu_activate = Libraries::Ime::ConsumeMenuActivatePress(
