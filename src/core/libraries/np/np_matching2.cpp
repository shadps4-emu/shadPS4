...
int PS4_SYSV_ABI sceNpMatching2CreateContext(const OrbisNpMatching2CreateContextParameter* param,
    ...
    LOG_DEBUG(Lib_NpMatching2, "called, npOnlineId = {}, serviceLabel = {}, size = {}",
    ...
    *requestId = id++;
    ...
    auto optParam =
        requestOpt ? *requestOpt
                   : (defaultRequestOptParam ? defaultRequestOptParam.value()
...
void ProcessEvents() {
    LOG_DEBUG(Lib_NpMatching2, "processing events");
    {
        std::scoped_lock lk{g_events_mutex};
