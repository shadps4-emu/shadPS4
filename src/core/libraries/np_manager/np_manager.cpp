...
void RegisterLib(Core::Loader::SymbolsResolver* sym) {
    LIB_FUNCTION("70N4VzVCpQg", "libSceNpManagerForSys", 1, "libSceNpManager",
                 Func_EF4378573542A508);
    LIB_FUNCTION("pHLjntY0psg", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpIpcCreateMemoryFromKernel);
    LIB_FUNCTION("UdhQmx64-uM", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpIpcCreateMemoryFromPool);
    LIB_FUNCTION("hyuye+88uPo", "libSceNpManager", 1, "libSceNpManager", _sceNpIpcDestroyMemory);
    LIB_FUNCTION("VY8Xji9cAFA", "libSceNpManager", 1, "libSceNpManager", _sceNpIpcFreeImpl);
    LIB_FUNCTION("V38nfJwXYhg", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpIpcGetNpMemAllocator);
    LIB_FUNCTION("VBZtcFn7+aY", "libSceNpManager", 1, "libSceNpManager", _sceNpIpcMallocImpl);
    LIB_FUNCTION("TyACAxDH3Uw", "libSceNpManager", 1, "libSceNpManager", _sceNpIpcReallocImpl);
    LIB_FUNCTION("fHGhS3uP52k", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpManagerCreateMemoryFromKernel);
    LIB_FUNCTION("v8+25H9WIX4", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpManagerCreateMemoryFromPool);
    LIB_FUNCTION("4uhgVNAqiag", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpManagerDestroyMemory);
    LIB_FUNCTION("8JX-S2ADen4", "libSceNpManager", 1, "libSceNpManager", _sceNpManagerFreeImpl);
    LIB_FUNCTION("ukEeOizCkIU", "libSceNpManager", 1, "libSceNpManager",
                 _sceNpManagerGetNpMemAllocator);
    LIB_FUNCTION("p0TfCdPEcsk", "libSceNpManager", 1, "libSceNpManager", _sceNpManagerMallocImpl);
    LIB_FUNCTION("PIYEFT1iG0Y", "libSceNpManager", 1, "libSceNpManager", _sceNpManagerReallocImpl);
    LIB_FUNCTION("o1azI8TGjbc", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineId13GetNpOnlineIdERKNS0_4UserEP13SceNpOnlineId);
    LIB_FUNCTION("1GRQfw+bhcE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineId13GetNpOnlineIdERKNS0_4UserEPS1_);
    LIB_FUNCTION("Icc9+aRUQfQ", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineId16SetNpOnlineIdStrEPKc);
    LIB_FUNCTION("-QlrD62pWME", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineId5ClearEv);
    LIB_FUNCTION("oGASj6Qjq7M", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC1ERK13SceNpOnlineId);
    LIB_FUNCTION("dgSWiLGbjuY", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC1ERKS1_);
    LIB_FUNCTION("YYfLHMi0+2M", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC1Ev);
    LIB_FUNCTION("mt2Be6qsnsw", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC2ERK13SceNpOnlineId);
    LIB_FUNCTION("gPux+0B5N9I", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC2ERKS1_);
    LIB_FUNCTION("gBeifc27nO4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdC2Ev);
    LIB_FUNCTION("kUsK6ZtqofM", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdD0Ev);
    LIB_FUNCTION("UyUHeYA21sg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdD1Ev);
    LIB_FUNCTION("YcMKsqoMBtg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np10NpOnlineIdD2Ev);
    LIB_FUNCTION("7I2lZS0DRjA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTrans13GetResultCodeEPNS0_6HandleE);
    LIB_FUNCTION("WoaqjY1ccEo", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTrans21SetRequestAccessTokenEPNS0_6HandleE);
    LIB_FUNCTION("mCqfLfIWWuo", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTrans24BuildAuthorizationHeaderERKNS0_13NpAccessTokenEPcm);
    LIB_FUNCTION("JDYbbgccPDE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTransC2EP16SceNpAllocatorEx);
    LIB_FUNCTION("Yd7V7lM4bSA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTransD0Ev);
    LIB_FUNCTION("7OiI1ObT1QU", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTransD1Ev);
    LIB_FUNCTION("D5qJmwMlccI", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np11NpHttpTransD2Ev);
    LIB_FUNCTION("CvGog64+vCk", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClient4InitEii);
    LIB_FUNCTION("QvqOkNK5ThU", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClientC1EP16SceNpAllocatorEx);
    LIB_FUNCTION("t+T8UG8jats", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClientC2EP16SceNpAllocatorEx);
    LIB_FUNCTION("FjbLZy95ts4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClientD0Ev);
    LIB_FUNCTION("kR3ed2pAvV8", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClientD1Ev);
    LIB_FUNCTION("9Uew6b9Pp8U", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpHttpClientD2Ev);
    LIB_FUNCTION("zAvqfrR2f7c", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleToken5ClearEv);
    LIB_FUNCTION("xQM94RIreRc", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenC1ERKS1_);
    LIB_FUNCTION("j6oWzyuDal4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenC1Ev);
    LIB_FUNCTION("oDMQ96CSgKE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenC2ERKS1_);
    LIB_FUNCTION("+3JWTVP4NUc", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenC2Ev);
    LIB_FUNCTION("SyxdUakD7HU", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenD0Ev);
    LIB_FUNCTION("+fA-tpNvZNg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenD1Ev);
    LIB_FUNCTION("43B0VnF0P7E", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np12NpTitleTokenD2Ev);
    LIB_FUNCTION("jjpTY0fRA44", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessToken14GetAccessTokenEPNS0_6HandleERKNS0_4UserEPS1_);
    LIB_FUNCTION("Y5eglu1FrsE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessToken5ClearEv);
    LIB_FUNCTION("FMoSUe3Uac4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC1ERK16SceNpAccessToken);
    LIB_FUNCTION("MwAYknEWfAU", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC1ERKS1_);
    LIB_FUNCTION("h8d3tfMiyhc", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC1Ev);
    LIB_FUNCTION("h0EenX2eWyA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC2ERK16SceNpAccessToken);
    LIB_FUNCTION("CNJoUbqVaFc", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC2ERKS1_);
    LIB_FUNCTION("2lzWy2xmnhY", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenC2Ev);
    LIB_FUNCTION("SFZYbH7eOnk", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenD0Ev);
    LIB_FUNCTION("0SfP+1+7aB4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenD1Ev);
    LIB_FUNCTION("u9tBiSNnvn8", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np13NpAccessTokenD2Ev);
    LIB_FUNCTION("D3ucpMtsmEw", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client10EndRequestEii);
    LIB_FUNCTION("tpXVNSFwJRs", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client11InitServiceEi);
    LIB_FUNCTION("UvDQq9+QMuI", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client11TermServiceEi);
    LIB_FUNCTION("huJ-2GzzNXs", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client11WaitRequestEiij);
    LIB_FUNCTION("EPEUMPT+9XI", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client12AbortRequestEii);
    LIB_FUNCTION("HhtuEAftVvk", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client12BeginRequestEii);
    LIB_FUNCTION("t5cZhzOEeDM", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client13CreateRequestEimPKvPi);
    LIB_FUNCTION("aFpR2VzmSqA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client13DeleteRequestEii);
    LIB_FUNCTION("hKTdrR1+dN0", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client13GetIpmiClientEv);
    LIB_FUNCTION("ZDocIq+2jbI", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client13PollEventFlagEijmjPm);
    LIB_FUNCTION("fs2BaxmsAZg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np3ipc14service_client14PollEventQueueEiPvm);
    LIB_FUNCTION("HSh8IJaDD7o", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpId5ClearEv);
    LIB_FUNCTION("6WTgpKqUxRo", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np4NpIdC1ERK7SceNpId);
    LIB_FUNCTION("SuCCD+AZwCc", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdC1ERKS1_);
    LIB_FUNCTION("YU-PxwZq21U", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdC1Ev);
    LIB_FUNCTION("ZHZ6QZ8xHLE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np4NpIdC2ERK7SceNpId);
    LIB_FUNCTION("qBlMzJbMa7c", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdC2ERKS1_);
    LIB_FUNCTION("OIdCMA7vGHA", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdC2Ev);
    LIB_FUNCTION("lUXyFGSFXKo", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdD0Ev);
    LIB_FUNCTION("WcfJXQ2NFP4", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdD1Ev);
    LIB_FUNCTION("ya+s8zGxVQQ", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4NpIdD2Ev);
    LIB_FUNCTION("GtMgx4YcBuo", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4User5ClearEv);
    LIB_FUNCTION("bwwspVgS4hQ", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np4User7GetUserEiPS1_);
    LIB_FUNCTION("Z4wnPrd9jIE", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC1Ei);
    LIB_FUNCTION("rgtbpTzx0RA", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC1ERKS1_);
    LIB_FUNCTION("S7Afe0llsL8", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC1Ev);
    LIB_FUNCTION("i2KGykoRA-4", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC2Ei);
    LIB_FUNCTION("YvL0D8Vg6VM", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC2ERKS1_);
    LIB_FUNCTION("F-AkFa9cABI", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserC2Ev);
    LIB_FUNCTION("HhKQodH164k", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserD0Ev);
    LIB_FUNCTION("gQFyT9aIsOk", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserD1Ev);
    LIB_FUNCTION("itBuc3IIDaY", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np4UserD2Ev);
    LIB_FUNCTION("BI3Wo2RpVmA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2np8NpTicket5ClearEv);
    LIB_FUNCTION("KjXpVcQXaYc", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np8NpTicketD0Ev);
    LIB_FUNCTION("AIMCjPPVWZM", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np8NpTicketD1Ev);
    LIB_FUNCTION("JL4zz6ehIWE", "libSceNpManager", 1, "libSceNpManager", _ZN3sce2np8NpTicketD2Ev);
    LIB_FUNCTION("-WGPScpDMWA", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npeqERK13SceNpOnlineIdRKNS0_10NpOnlineIdE);
    LIB_FUNCTION("m3jEtGAP9jE", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npeqERKNS0_10NpOnlineIdERK13SceNpOnlineId);
    LIB_FUNCTION("KGitZXuSY7U", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npeqERKNS0_10NpOnlineIdES3_);
    LIB_FUNCTION("0qjYM9bp5vs", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npeqERKNS0_4UserERKi);
    LIB_FUNCTION("-BgzebSMaVY", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npeqERKNS0_4UserES3_);
    LIB_FUNCTION("-lWtMfBycrg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npneERK13SceNpOnlineIdRKNS0_10NpOnlineIdE);
    LIB_FUNCTION("d-nucrQRJZg", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npneERKNS0_10NpOnlineIdERK13SceNpOnlineId);
    LIB_FUNCTION("pt8E9JYqZm4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npneERKNS0_10NpOnlineIdES3_);
    LIB_FUNCTION("XlGEzCqlHpI", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npneERKNS0_4UserERKi);
    LIB_FUNCTION("ta8lASAxro4", "libSceNpManager", 1, "libSceNpManager",
                 _ZN3sce2npneERKNS0_4UserES3_);
    LIB_FUNCTION("IIBBieYYH6M", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np10NpOnlineId7IsEmptyEv);
    LIB_FUNCTION("lDCWWROsrEg", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np12NpTitleToken6GetStrEv);
    LIB_FUNCTION("2lvOARTF5x0", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np13NpAccessToken7IsEmptyEv);
    LIB_FUNCTION("noJm52uLN00", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User10IsLoggedInEv);
    LIB_FUNCTION("f2K8i7KU20k", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User12GetAccountIdEPm);
    LIB_FUNCTION("2hiV0v27kcY", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User12HasAccountIdEPb);
    LIB_FUNCTION("GZ2YtnlAzH4", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User25GetAccountIdFromRegistoryEPm);
    LIB_FUNCTION("IyT41iG8Ync", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User7IsEmptyEv);
    LIB_FUNCTION("JwpT2LYSxrg", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User7IsGuestEv);
    LIB_FUNCTION("td8GJFROaEA", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np4User9GetUserIdEv);
    LIB_FUNCTION("ox2Ie98lPAQ", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np8NpTicket13GetTicketDataEv);
    LIB_FUNCTION("fs1TCWwTYCA", "libSceNpManager", 1, "libSceNpManager",
                 _ZNK3sce2np8NpTicket13GetTicketSizeEv);
    LIB_FUNCTION("i80IWKzGrCE", "libSceNpManager", 1, "libSceNpManager",
                 _ZThn16_N3sce2np11NpHttpTransD0Ev);
    LIB_FUNCTION("rbsJZPsEjN8", "libSceNpManager", 1, "libSceNpManager",
                 _ZThn16_N3sce2np11NpHttpTransD1Ev);
    LIB_FUNCTION("YudSGKQqqnI", "libSceNpManager", 1, "libSceNpManager",
                 _ZThn8_N3sce2np11NpHttpTransD0Ev);
    LIB_FUNCTION("mHE2Hk9Ki80", "libSceNpManager", 1, "libSceNpManager",
                 _ZThn8_N3sce2np11NpHttpTransD1Ev);
    LIB_FUNCTION("OzKvTvg3ZYU", "libSceNpManager", 1, "libSceNpManager", sceNpAbortRequest);
    LIB_FUNCTION("JrXA7baBMPQ", "libSceNpManager", 1, "libSceNpManager", sceNpAsmAbort);
    LIB_FUNCTION("0cn2c-bk8wA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientAbortRequest);
    LIB_FUNCTION("coT6qsU5t9M", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientClearNpTitleToken);
    LIB_FUNCTION("zHxRg0AUZm8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientClearNpTitleTokenA);
    LIB_FUNCTION("tOJ-WGFDt-Y", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientCreateRequest2);
    LIB_FUNCTION("GPRRxFM01r4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientCreateResourceContext);
    LIB_FUNCTION("Auqk+H3qGuo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientCreateResourceContext2);
    LIB_FUNCTION("1wMn3X94WME", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientDeleteRequest);
    LIB_FUNCTION("KA2AITpVTCg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientDeleteResourceContext);
    LIB_FUNCTION("4gi0acCfJL4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientDeleteResourceContext2);
    LIB_FUNCTION("yWcto7E39+k", "libSceNpManager", 1, "libSceNpManager", sceNpAsmClientGetAppId);
    LIB_FUNCTION("Q7fnpdkjBp0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetCacheControlMaxAge);
    LIB_FUNCTION("vf+lYeOXdI8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetGameNpTitleInfo);
    LIB_FUNCTION("YQ7-z4zFWok", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetGameNpTitleToken);
    LIB_FUNCTION("6bvqnBIINiY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetGameTitleBanInfo);
    LIB_FUNCTION("cOLn5A3ZoqU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpComInfo2);
    LIB_FUNCTION("P6fkTotWFEg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpComInfo2A);
    LIB_FUNCTION("fX+iM4sZIl0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpComInfo2WithHmac);
    LIB_FUNCTION("uObO1I15Se0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpComInfo3);
    LIB_FUNCTION("u+iH3rRyPEE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpComInfo4);
    LIB_FUNCTION("nuPl4uVXYMM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpTitleId);
    LIB_FUNCTION("HtpGVrVLOlA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpTitleToken);
    LIB_FUNCTION("2GbOPwcNJd0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpTitleToken2);
    LIB_FUNCTION("cugDQBHux8k", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetNpTitleTokenA);
    LIB_FUNCTION("rT4NWysyX+g", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetRelatedGameNpTitleIds);
    LIB_FUNCTION("scCBvfXGeRM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetRelatedGameNpTitleIdsA);
    LIB_FUNCTION("TtHBV0mH8kY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetRelatedGameNpTitleIdsResult);
    LIB_FUNCTION("O42ZlBvIPMM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceBaseUrl);
    LIB_FUNCTION("iRvaaSfHBc8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceBaseUrlA);
    LIB_FUNCTION("nxpboyvJGf4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceBaseUrlWithNpTitleId);
    LIB_FUNCTION("wXpm75McNZo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceBaseUrlWithNpTitleIdA);
    LIB_FUNCTION("TiC81-OKjpg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceIdInfo);
    LIB_FUNCTION("3rlqy6XxrmI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientGetServiceIdInfoA);
    LIB_FUNCTION("wZy5M6lzip0", "libSceNpManager", 1, "libSceNpManager", sceNpAsmClientInitialize);
    LIB_FUNCTION("9o4inFK-oWc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmClientSetNpTitleId);
    LIB_FUNCTION("cu1LlJo+5EY", "libSceNpManager", 1, "libSceNpManager", sceNpAsmClientTerminate);
    LIB_FUNCTION("YDDHD6RP4HQ", "libSceNpManager", 1, "libSceNpManager", sceNpAsmCreateConnection);
    LIB_FUNCTION("hIFFMeoLhcY", "libSceNpManager", 1, "libSceNpManager", sceNpAsmCreateRequest);
    LIB_FUNCTION("UxOJvGmy3mA", "libSceNpManager", 1, "libSceNpManager", sceNpAsmDeleteConnection);
    LIB_FUNCTION("RfokKHMuOsE", "libSceNpManager", 1, "libSceNpManager", sceNpAsmDeleteRequest);
    LIB_FUNCTION("ulPuWk7bYCU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmGenerateNpTitleToken);
    LIB_FUNCTION("0bCpZmASTm4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmGenerateNpTitleToken2);
    LIB_FUNCTION("dSlkmPVTcvk", "libSceNpManager", 1, "libSceNpManager", sceNpAsmGetNpCommInfo);
    LIB_FUNCTION("IDXFgpkpDsU", "libSceNpManager", 1, "libSceNpManager", sceNpAsmGetNpCommInfo2);
    LIB_FUNCTION("Dkpw9X-HSVA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpAsmGetRelatedGameNpTitleIds);
    LIB_FUNCTION("kc-O9XKFRIE", "libSceNpManager", 1, "libSceNpManager", sceNpAsmGetServiceBaseUrl);
    LIB_FUNCTION("1Xe+XZ1oI28", "libSceNpManager", 1, "libSceNpManager", sceNpAsmGetServiceIdInfo);
    LIB_FUNCTION("j2dSNi+SJro", "libSceNpManager", 1, "libSceNpManager", sceNpAsmInitialize);
    LIB_FUNCTION("Dt2rEe-d5c0", "libSceNpManager", 1, "libSceNpManager", sceNpAsmTerminate);
    ...
    LIB_FUNCTION("+4DegjBqV1g", "libSceNpManager", 1, "libSceNpManager", sceNpGetAccountAge);
    ...
    LIB_FUNCTION("3Tcz5bNCfZQ", "libSceNpManager", 1, "libSceNpManager", sceNpGetAccountLanguage2);
    ...
    LIB_FUNCTION("fJuQuipzW10", "libSceNpManager", 1, "libSceNpManager", sceNpIdMapperAbortRequest);
    LIB_FUNCTION("alNLle2vACg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperAccountIdToNpId);
    LIB_FUNCTION("TV3KKXZLUj4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperAccountIdToOnlineId);
    LIB_FUNCTION("lCAYAK4kfkc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperCreateRequest);
    LIB_FUNCTION("Z8nyVQCGCVo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperDeleteRequest);
    LIB_FUNCTION("21FMz6O4B2E", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperNpIdToAccountId);
    LIB_FUNCTION("zEZvGyjEhuk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIdMapperOnlineIdToAccountId);
    LIB_FUNCTION("BdykpTwq2bs", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageAbortHandle);
    LIB_FUNCTION("lp7vzwISXMg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageCheckCallback);
    LIB_FUNCTION("s4UEa5iBJdc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageCreateHandle);
    LIB_FUNCTION("+anuSx2avHQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageDeleteHandle);
    LIB_FUNCTION("Ubv+fP58W1U", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageGetMemoryPoolStatistics);
    LIB_FUNCTION("GFhVUpRmbHE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageInitialize);
    LIB_FUNCTION("Vh1bhUG6mSs", "libSceNpManager", 1, "libSceNpManager", sceNpInGameMessagePrepare);
    LIB_FUNCTION("IkL62FMpIpo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessagePrepareA);
    LIB_FUNCTION("ON7Sf5XEMmI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageSendData);
    LIB_FUNCTION("PQDFxcnqxtw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageSendDataA);
    LIB_FUNCTION("bMG3cVmUmuk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpInGameMessageTerminate);
    LIB_FUNCTION("GsWjzRU7AWA", "libSceNpManager", 1, "libSceNpManager", sceNpIntCheckPlus);
    LIB_FUNCTION("H6xqSNWg0wM", "libSceNpManager", 1, "libSceNpManager", sceNpIntGetAppType);
    LIB_FUNCTION("SdNiYQWjU6E", "libSceNpManager", 1, "libSceNpManager",
    ...
    LIB_FUNCTION("bZ2mBvP79d8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpIntRegisterGamePresenceCallback);
    LIB_FUNCTION("Ybu6AxV6S0o", "libSceNpManager", 1, "libSceNpManager", sceNpIsPlusMember);
    LIB_FUNCTION("AUuzKQIwhXY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAbortRequest);
    LIB_FUNCTION("J0MUxuo9H9c", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAddActiveSigninStateCallback);
    LIB_FUNCTION("wIX4m0mLfqA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAddOnlineIdChangeCallback);
    LIB_FUNCTION("E6rzFwsDFwE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAddPlusMemberTypeCallback);
    LIB_FUNCTION("S9xDus0Cums", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAddSigninStateCallback);
    LIB_FUNCTION("1aifBDr9oqc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAuthGetAuthorizationCode);
    LIB_FUNCTION("fMWCG0Tqofg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntAuthGetIdToken);
    LIB_FUNCTION("97RAfJch+qE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntBindOfflineAccountId);
    LIB_FUNCTION("Xg7dJekKeHM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCheckGameNpAvailability);
    LIB_FUNCTION("m4JiU8k2PyI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCheckNpAvailability);
    LIB_FUNCTION("d+lmTLvsaRs", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCheckNpAvailabilityByPid);
    LIB_FUNCTION("Dvk+xqAqXco", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCheckNpState);
    LIB_FUNCTION("U30AU92fWdU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCheckNpStateA);
    LIB_FUNCTION("r7d8eEp5vJE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntClearGameAccessToken);
    LIB_FUNCTION("5ZoFb+9L7LY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntClearOnlineIdChangeFlag);
    LIB_FUNCTION("6TTRm8KRqbw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntClearTicket);
    LIB_FUNCTION("QZpXoz9wjbE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntClearUsedFlag);
    LIB_FUNCTION("miJIPnB2cfI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntClearVshAccessToken);
    LIB_FUNCTION("6n8NT1pHW9g", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCreateLoginContext);
    LIB_FUNCTION("CdQg39qlfgY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCreateLoginRequest);
    LIB_FUNCTION("xZk+QcivrFE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntCreateRequest);
    LIB_FUNCTION("EgmlHG93Tpw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntDeleteLoginContext);
    LIB_FUNCTION("HneC+SpeLwc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntDeleteRequest);
    LIB_FUNCTION("7+uKCMe4SLk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountCountry);
    LIB_FUNCTION("fjJ4xXM+3Tw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountCountryA);
    LIB_FUNCTION("mUcn35JWAvI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountCountrySdk);
    LIB_FUNCTION("CConkVwc7Dc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountDateOfBirthA);
    LIB_FUNCTION("3TbxIy0VEiU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountDateOfBirthSdk);
    LIB_FUNCTION("XS-eY7KRqjQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountId);
    LIB_FUNCTION("1H07-M8fGec", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountIdSdk);
    LIB_FUNCTION("C6xstRBFOio", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountLanguage);
    LIB_FUNCTION("e6rTjFmcQjY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountLanguageA);
    LIB_FUNCTION("HvNrMhlWBSk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountNpEnv);
    LIB_FUNCTION("9lz4fkS+eEk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAccountType);
    LIB_FUNCTION("UAA2-ZTmgJc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetActiveSigninState);
    LIB_FUNCTION("1DMXuE0CbGQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAuthorizationCodeA);
    LIB_FUNCTION("xPvV6oMKOWY", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAuthorizationCodeWithPsnoUri);
    LIB_FUNCTION("HkUgFhrpAD4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetAuthServerErrorFlag);
    LIB_FUNCTION("TXzpCgPmXEQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetClientCredentialAccessToken);
    LIB_FUNCTION("A3m-y8VVgqM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetCommunicationRestrictionStatus);
    LIB_FUNCTION("iTXe6EWAHek", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetGameAccessToken);
    LIB_FUNCTION("es6OiIxGiL0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetIssuerId);
    LIB_FUNCTION("jCJEWuExbZg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetLastAccountLanguage);
    LIB_FUNCTION("Oad+nopFTTA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetMAccountId);
    LIB_FUNCTION("BTRVfOx7K1c", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetNpEnv);
    LIB_FUNCTION("azEmYv5NqWo", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetNpId);
    LIB_FUNCTION("gFB0RmKjyaI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetNpIdByOnlineId);
    LIB_FUNCTION("41CVMRinjWU", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetNpIdSdk);
    LIB_FUNCTION("70Swvw7h6ck", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetOfflineAccountId);
    LIB_FUNCTION("QnO8zMmKcGE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetOnlineIdByAccountId);
    LIB_FUNCTION("lYkDUwyzr0s", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetOnlineIdChangeFlag);
    LIB_FUNCTION("jkQKWQTOu8g", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetOnlineIdInternal);
    LIB_FUNCTION("sTtvF4QVhjg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetOnlineIdSdk);
    LIB_FUNCTION("FqtDOHUuDNw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetParentalControlFlag);
    LIB_FUNCTION("NS1sEhoj-B0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetParentalControlInfo);
    LIB_FUNCTION("ggj9Qm4XDrU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetParentalControlInfoA);
    LIB_FUNCTION("vrre3KW6OPg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetPlusMemberType);
    LIB_FUNCTION("XRFchqddEVU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetPlusMemberTypeNB);
    LIB_FUNCTION("iDlso2ZrQfA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetServerError);
    LIB_FUNCTION("6miba-pcQt8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetSigninState);
    LIB_FUNCTION("uVAfWmv+cc8", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetTicket);
    LIB_FUNCTION("43B0lauksLY", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetTicketA);
    LIB_FUNCTION("HsHttp1Ktm0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetTitleTokenWithCheck);
    LIB_FUNCTION("OZTedKNUeFU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByAccountId);
    LIB_FUNCTION("uxLmJ141PmA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByMAccountId);
    LIB_FUNCTION("MDczH3SxE9Q", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByNpId);
    LIB_FUNCTION("Nhxy2NmQhbs", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByOfflineAccountId);
    LIB_FUNCTION("uSLgWz8ohak", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByOnlineId);
    LIB_FUNCTION("H33CwgKf4Rs", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserIdByOnlineIdSdk);
    LIB_FUNCTION("PL10NiZ0XNA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetUserList);
    LIB_FUNCTION("etZ84Rf3Urw", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntGetUserNum);
    LIB_FUNCTION("mBTFixSxTzQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetVshAccessToken);
    LIB_FUNCTION("+waQfICfHaw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetVshAccessTokenWithCheck);
    LIB_FUNCTION("3f0ejg9vcE8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntGetVshClientId);
    LIB_FUNCTION("ossvuXednsc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntIsSubAccount);
    LIB_FUNCTION("atgHp5dQi5k", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntIsTemporarySignout);
    LIB_FUNCTION("jwOjEhWD6E4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntIsUnregisteredClientError);
    LIB_FUNCTION("aU5QaUCW-Ik", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginAddJsonInfo);
    LIB_FUNCTION("KQYLX4tVLe4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginAuthenticate);
    LIB_FUNCTION("bzf8a7LxtCQ", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntLoginBind);
    LIB_FUNCTION("xAdGRA3ucDg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGet2svInfo);
    LIB_FUNCTION("-P0LG2EUFBE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetAccessToken);
    LIB_FUNCTION("38cfkczfN08", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetAccessTokenViaImplicitFlow);
    LIB_FUNCTION("dvkqP9KUMfk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetAccountId);
    LIB_FUNCTION("sEZaB9KQ10k", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetAuthenticateResponse);
    LIB_FUNCTION("Y+hLqeLseRk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetAuthorizationCode);
    LIB_FUNCTION("EXeJ80p01gs", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetDeviceCodeInfo);
    LIB_FUNCTION("yqsFy9yg2rU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetEmail);
    LIB_FUNCTION("wXfHhmzUjK4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetOnlineId);
    LIB_FUNCTION("yWMBHiRdEbk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginGetUserId);
    LIB_FUNCTION("uaCfG0TAPmg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginParseJsonUserInfo);
    LIB_FUNCTION("yHl0pPA3rPQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginResetSsoToken);
    LIB_FUNCTION("0cLPZO1Voe8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginRevalidatePassword);
    LIB_FUNCTION("hmVLIi3pQDE", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginSetAccountInfo);
    LIB_FUNCTION("X-WHexCbxcI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginSetSsoToken);
    LIB_FUNCTION("rCnvauevHHc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginSignin);
    LIB_FUNCTION("qmZHHehEDog", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginValidateCredential);
    LIB_FUNCTION("zXukItkUuko", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginValidateKratosAuthCode);
    LIB_FUNCTION("ujtFwWJnv+E", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntLoginVerifyDeviceCode);
    LIB_FUNCTION("d0IkWV+u25g", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntPfAuth);
    LIB_FUNCTION("SuBDgQswXgo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntRemoveActiveSigninStateCallback);
    LIB_FUNCTION("5nayeu8VK5Y", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntRemoveOnlineIdChangeCallback);
    LIB_FUNCTION("PafRf+sxnwA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntRemovePlusMemberTypeCallback);
    LIB_FUNCTION("zh2KsQZlAN4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntRemoveSigninStateCallback);
    LIB_FUNCTION("k4M1w5Xstck", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntRevalidatePassword);
    LIB_FUNCTION("C77VnsdaKKI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntSetPlusMemberTypeNB);
    LIB_FUNCTION("PZhz+vjp2CM", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntSetTimeout);
    LIB_FUNCTION("64D6V-ADQe0", "libSceNpManager", 1, "libSceNpManager", sceNpManagerIntSignout);
    LIB_FUNCTION("+IagDajB6AQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntSubmitUserCode);
    LIB_FUNCTION("wUT4cOK0bj0", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntTemporarySignout);
    LIB_FUNCTION("IG6ZoGSDaMk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntUnbindOfflineAccountId);
    LIB_FUNCTION("dTvQe2clcNw", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntUpdateVshAccessToken);
    LIB_FUNCTION("6AcoqeEhs6E", "libSceNpManager", 1, "libSceNpManager",
                 sceNpManagerIntWebLoginRequired);
    LIB_FUNCTION("LGEIdgILQek", "libSceNpManager", 1, "libSceNpManager", sceNpManagerPrxStartVsh);
    LIB_FUNCTION("9P8qV9WtgKA", "libSceNpManager", 1, "libSceNpManager", sceNpManagerPrxStopVsh);
    ...
    LIB_FUNCTION("QGN2n4c8na4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2CreateUserContext);
    LIB_FUNCTION("HnV+y1xVP2c", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2DeleteUserContext);
    LIB_FUNCTION("sDqpKnwnAJQ", "libSceNpManager", 1, "libSceNpManager", sceNpPush2Init);
    LIB_FUNCTION("i1lhp0Wlu+k", "libSceNpManager", 1, "libSceNpManager", sceNpPush2IsInit);
    LIB_FUNCTION("KnOXRM1i6KM", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2OptionalCheckCallback);
    LIB_FUNCTION("CsIrEmYADDo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2RegisterDataType);
    LIB_FUNCTION("4ic6Lb+mlfA", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2RegisterExtendedDataFilter);
    LIB_FUNCTION("OdRcux-QXm8", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2RegisterNotificationExCallback);
    LIB_FUNCTION("KiXYNfe7r9o", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2SendPushStatisticsDataSystemTelemetry);
    LIB_FUNCTION("+rPzLhUKj1Y", "libSceNpManager", 1, "libSceNpManager", sceNpPush2SetGlobalMutex);
    LIB_FUNCTION("Y1EmilNpj3Y", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2SetNpCommunicationId);
    LIB_FUNCTION("KjAjcg3W7F8", "libSceNpManager", 1, "libSceNpManager", sceNpPush2Term);
    LIB_FUNCTION("i9NM4gcpZhk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2TriggerEmptyUserEvent);
    LIB_FUNCTION("rwM99K5fzIk", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2UnregisterDataType);
    LIB_FUNCTION("LpfRp+-sitI", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2UnregisterExtendedDataFilter);
    LIB_FUNCTION("2q3IIivs72Q", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2UnregisterNotificationExCallback);
    LIB_FUNCTION("tkNfuSDEgYg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPush2UnsetNpCommunicationId);
    LIB_FUNCTION("c3T1XEYr9MI", "libSceNpManager", 1, "libSceNpManager", sceNpPush2WaitCallback);
    LIB_FUNCTION("kdrdY-BEJMw", "libSceNpManager", 1, "libSceNpManager", sceNpPushCheckCallback);
    LIB_FUNCTION("DkN+WBclFps", "libSceNpManager", 1, "libSceNpManager", sceNpPushInit);
    LIB_FUNCTION("1S2urF24zNQ", "libSceNpManager", 1, "libSceNpManager", sceNpPushIntBeginInactive);
    LIB_FUNCTION("XyvQv2qjUng", "libSceNpManager", 1, "libSceNpManager", sceNpPushIntEndInactive);
    LIB_FUNCTION("B7bQNq1KPQQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushIntGetBindUserState);
    LIB_FUNCTION("O-2TTjhWw10", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushIntGetConnectionState);
    LIB_FUNCTION("Lg5mNqy1zdQ", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushIntRegisterNotificationPacketCallback);
    LIB_FUNCTION("RSnzCRbqwDU", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushIntUnregisterNotificationPacketCallback);
    LIB_FUNCTION("U9hX5ssnYZ4", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushRegisterExtendedDataFilter);
    LIB_FUNCTION("l3dG7h4TlLg", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushRegisterNotificationExCallback);
    LIB_FUNCTION("rjatoAGW+Fo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushSetNpCommunicationId);
    LIB_FUNCTION("a7ipJQTfQwo", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushStartNotification);
    LIB_FUNCTION("uhSJXVMYQWc", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushStartNotificationA);
    LIB_FUNCTION("d695X978Bgw", "libSceNpManager", 1, "libSceNpManager", sceNpPushStopNotification);
    LIB_FUNCTION("Xa1igyHioag", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushStopNotificationA);
    LIB_FUNCTION("qo5mH49gnDA", "libSceNpManager", 1, "libSceNpManager", sceNpPushTerm);
    LIB_FUNCTION("VxjXt8G-9Ns", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushUnregisterExtendedDataFilter);
    LIB_FUNCTION("6MuJ-vnDk6A", "libSceNpManager", 1, "libSceNpManager",
                 sceNpPushUnregisterNotificationCallback);
    LIB_FUNCTION("j1YsEXl5ta4", "libSceNpManager", 1, "libSceNpManager",
    ...
    LIB_FUNCTION("JHOtNtQ-jmw", "libSceNpManager", 1, "libSceNpManager", sceNpServiceClientInit);
    LIB_FUNCTION("Hhmu86aYI1E", "libSceNpManager", 1, "libSceNpManager", sceNpServiceClientTerm);
    LIB_FUNCTION("41gDrpv1pTw", "libSceNpManager", 1, "libSceNpManager", sceNpSetAdditionalScope);
    ...
    LIB_FUNCTION("TJqSgUEzexM", "libSceNpManager", 1, "libSceNpManager", sceNpSetNpTitleIdVsh);
    ...
    LIB_FUNCTION("BQA2KNZr2H0", "libSceNpManager", 1, "libSceNpManager", Func_05003628D66BD87D);
    LIB_FUNCTION("DDiKTyHJivk", "libSceNpManager", 1, "libSceNpManager", Func_0C388A4F21C98AF9);
    LIB_FUNCTION("DOzHoIo+UK8", "libSceNpManager", 1, "libSceNpManager", Func_0CECC7A08A3E50AF);
    LIB_FUNCTION("DRcDCh2hjus", "libSceNpManager", 1, "libSceNpManager", Func_0D17030A1DA18EEB);
    LIB_FUNCTION("Dw8yC2rYpT0", "libSceNpManager", 1, "libSceNpManager", Func_0F0F320B6AD8A53D);
    LIB_FUNCTION("ETxHcJD5oXQ", "libSceNpManager", 1, "libSceNpManager", Func_113C477090F9A174);
    LIB_FUNCTION("EtNn1ccn8Ag", "libSceNpManager", 1, "libSceNpManager", Func_12D367D5C727F008);
    LIB_FUNCTION("FkASC9R1kx4", "libSceNpManager", 1, "libSceNpManager", Func_1640120BD475931E);
    LIB_FUNCTION("Gv4cB8leZaU", "libSceNpManager", 1, "libSceNpManager", Func_1AFE1C07C95E65A5);
    LIB_FUNCTION("HZg8fgworHI", "libSceNpManager", 1, "libSceNpManager", Func_1D983C7E0C28AC72);
    LIB_FUNCTION("IIlDaVo7WP4", "libSceNpManager", 1, "libSceNpManager", Func_208943695A3B58FE);
    LIB_FUNCTION("JYo9EMmaQ7s", "libSceNpManager", 1, "libSceNpManager", Func_258A3D10C99A43BB);
    LIB_FUNCTION("Jj4yV5S0Eqw", "libSceNpManager", 1, "libSceNpManager", Func_263E325794B412AC);
    LIB_FUNCTION("K2pL81xeJA0", "libSceNpManager", 1, "libSceNpManager", Func_2B6A4BF35C5E240D);
    LIB_FUNCTION("K3B--gWssAk", "libSceNpManager", 1, "libSceNpManager", Func_2B707FFE05ACB009);
    LIB_FUNCTION("LOWrIw66+LQ", "libSceNpManager", 1, "libSceNpManager", Func_2CE5AB230EBAF8B4);
    LIB_FUNCTION("MjfuPDr8GHs", "libSceNpManager", 1, "libSceNpManager", Func_3237EE3C3AFC187B);
    LIB_FUNCTION("M9TfsqFgO-8", "libSceNpManager", 1, "libSceNpManager", Func_33D4DFB2A1603BFF);
    LIB_FUNCTION("OCHXnB7YbzM", "libSceNpManager", 1, "libSceNpManager", Func_3821D79C1ED86F33);
    LIB_FUNCTION("P0MZl8cQW78", "libSceNpManager", 1, "libSceNpManager", Func_3F431997C7105BBF);
    LIB_FUNCTION("QZJ5fC0tP8M", "libSceNpManager", 1, "libSceNpManager", Func_4192797C2D2D3FC3);
    LIB_FUNCTION("Qcfj2Iu7f3U", "libSceNpManager", 1, "libSceNpManager", Func_41C7E3D88BBB7F75);
    LIB_FUNCTION("Q49ghYqIP88", "libSceNpManager", 1, "libSceNpManager", Func_438F60858A883FCF);
    LIB_FUNCTION("TEoGLlZg+r0", "libSceNpManager", 1, "libSceNpManager", Func_4C4A062E5660FABD);
    LIB_FUNCTION("TICPek76Nqc", "libSceNpManager", 1, "libSceNpManager", Func_4C808F7A4EFA36A7);
    LIB_FUNCTION("ThztfmL2j0Y", "libSceNpManager", 1, "libSceNpManager", Func_4E1CED7E62F68F46);
    LIB_FUNCTION("UWGkjGphxL8", "libSceNpManager", 1, "libSceNpManager", Func_5161A48C6A61C4BF);
    LIB_FUNCTION("VCYDmZygruk", "libSceNpManager", 1, "libSceNpManager", Func_542603999CA0AEE9);
    LIB_FUNCTION("VGkLQcESh5k", "libSceNpManager", 1, "libSceNpManager", Func_54690B41C1128799);
    LIB_FUNCTION("VadsfClSH60", "libSceNpManager", 1, "libSceNpManager", Func_55A76C7C29521FAD);
    LIB_FUNCTION("VisjSq4l+Aw", "libSceNpManager", 1, "libSceNpManager", Func_562B234AAE25F80C);
    LIB_FUNCTION("WNGXUCbdhko", "libSceNpManager", 1, "libSceNpManager", Func_58D1975026DD864A);
    LIB_FUNCTION("WmA5X4w-4Sg", "libSceNpManager", 1, "libSceNpManager", Func_5A60395F8C3FE128);
    LIB_FUNCTION("Wzgnd+m18pQ", "libSceNpManager", 1, "libSceNpManager", Func_5B382777E9B5F294);
    LIB_FUNCTION("XbMB+c1klnE", "libSceNpManager", 1, "libSceNpManager", Func_5DB301F9CD649671);
    LIB_FUNCTION("ZEHVWGnY1vI", "libSceNpManager", 1, "libSceNpManager", Func_6441D55869D8D6F2);
    LIB_FUNCTION("aQaOGIVChN4", "libSceNpManager", 1, "libSceNpManager", Func_69068E18854284DE);
    LIB_FUNCTION("b1nDsAsD4Fo", "libSceNpManager", 1, "libSceNpManager", Func_6F59C3B00B03E05A);
    LIB_FUNCTION("ckzOf3ihNWs", "libSceNpManager", 1, "libSceNpManager", Func_724CCE7F78A1356B);
    LIB_FUNCTION("dQ8bBTwkMwg", "libSceNpManager", 1, "libSceNpManager", Func_750F1B053C243308);
    LIB_FUNCTION("dg8Hm7kd4lg", "libSceNpManager", 1, "libSceNpManager", Func_760F079BB91DE258);
    LIB_FUNCTION("eGV1IyIVVu8", "libSceNpManager", 1, "libSceNpManager", Func_78657523221556EF);
    LIB_FUNCTION("gImIi9Nj7aY", "libSceNpManager", 1, "libSceNpManager", Func_8089888BD363EDA6);
    LIB_FUNCTION("gQygKbb3w6E", "libSceNpManager", 1, "libSceNpManager", Func_810CA029B6F7C3A1);
    LIB_FUNCTION("glO5Roao0-0", "libSceNpManager", 1, "libSceNpManager", Func_8253B94686A8D3FD);
    LIB_FUNCTION("hmUTinCeFlQ", "libSceNpManager", 1, "libSceNpManager", Func_8665138A709E1654);
    LIB_FUNCTION("iC9I+uYJfAw", "libSceNpManager", 1, "libSceNpManager", Func_882F48FAE6097C0C);
    LIB_FUNCTION("idvkszA-+Ig", "libSceNpManager", 1, "libSceNpManager", Func_89DBE4B3303FF888);
    LIB_FUNCTION("i9PldiC93Dg", "libSceNpManager", 1, "libSceNpManager", Func_8BD3E57620BDDC38);
    LIB_FUNCTION("jwp0ATrWM+w", "libSceNpManager", 1, "libSceNpManager", Func_8F0A74013AD633EC);
    LIB_FUNCTION("j6YmS-P2zAA", "libSceNpManager", 1, "libSceNpManager", Func_8FA6264BF3F6CC00);
    LIB_FUNCTION("kpLofCwJceQ", "libSceNpManager", 1, "libSceNpManager", Func_9292E87C2C0971E4);
    LIB_FUNCTION("ksopIxjKA6g", "libSceNpManager", 1, "libSceNpManager", Func_92CA292318CA03A8);
    LIB_FUNCTION("k0hZbCsX9mI", "libSceNpManager", 1, "libSceNpManager", Func_9348596C2B17F662);
    LIB_FUNCTION("lQfpsyGl4Nc", "libSceNpManager", 1, "libSceNpManager", Func_9507E9B321A5E0D7);
    LIB_FUNCTION("mMqV4jGYBzE", "libSceNpManager", 1, "libSceNpManager", Func_98CA95E231980731);
    LIB_FUNCTION("nmbMS78sGZA", "libSceNpManager", 1, "libSceNpManager", Func_9E66CC4BBF2C1990);
    LIB_FUNCTION("nmzvcGSJH4Q", "libSceNpManager", 1, "libSceNpManager", Func_9E6CEF7064891F84);
    LIB_FUNCTION("p7wseS6VIsU", "libSceNpManager", 1, "libSceNpManager", Func_A7BC2C792E9522C5);
    LIB_FUNCTION("q7oPgJVIywI", "libSceNpManager", 1, "libSceNpManager", Func_ABBA0F809548CB02);
    LIB_FUNCTION("sUonpM7eAg8", "libSceNpManager", 1, "libSceNpManager", Func_B14A27A4CEDE020F);
    LIB_FUNCTION("syPuHCOrl-M", "libSceNpManager", 1, "libSceNpManager", Func_B323EE1C23AB97F3);
    LIB_FUNCTION("tCmBna70C6w", "libSceNpManager", 1, "libSceNpManager", Func_B429819DAEF40BAC);
    LIB_FUNCTION("tUuVcb6tgsU", "libSceNpManager", 1, "libSceNpManager", Func_B54B9571BEAD82C5);
    LIB_FUNCTION("tay1z0pBFKY", "libSceNpManager", 1, "libSceNpManager", Func_B5ACB5CF4A4114A6);
    LIB_FUNCTION("ukG+D0QVfuQ", "libSceNpManager", 1, "libSceNpManager", Func_BA41BE0F44157EE4);
    LIB_FUNCTION("uqHeyEjZlpA", "libSceNpManager", 1, "libSceNpManager", Func_BAA1DEC848D99690);
    LIB_FUNCTION("u4zM1slIDrI", "libSceNpManager", 1, "libSceNpManager", Func_BB8CCCD6C9480EB2);
    LIB_FUNCTION("vsJdqui4uB8", "libSceNpManager", 1, "libSceNpManager", Func_BEC25DAAE8B8B81F);
    LIB_FUNCTION("v+6TY5GrDHA", "libSceNpManager", 1, "libSceNpManager", Func_BFEE936391AB0C70);
    LIB_FUNCTION("wN0tvi6mb3o", "libSceNpManager", 1, "libSceNpManager", Func_C0DD2DBE2EA66F7A);
    LIB_FUNCTION("wfhYv1uGwqE", "libSceNpManager", 1, "libSceNpManager", Func_C1F858BF5B86C2A1);
    LIB_FUNCTION("wkBhjm-DkgY", "libSceNpManager", 1, "libSceNpManager", Func_C240618E6FC39206);
    LIB_FUNCTION("wzijRFAxDnk", "libSceNpManager", 1, "libSceNpManager", Func_C338A34450310E79);
    LIB_FUNCTION("yR7jYD2WaQk", "libSceNpManager", 1, "libSceNpManager", Func_C91EE3603D966909);
    LIB_FUNCTION("y2cDXtZoz2s", "libSceNpManager", 1, "libSceNpManager", Func_CB67035ED668CF6B);
    LIB_FUNCTION("1aWii3NRqb4", "libSceNpManager", 1, "libSceNpManager", Func_D5A5A28B7351A9BE);
    LIB_FUNCTION("2oQmBZ8dWi0", "libSceNpManager", 1, "libSceNpManager", Func_DA8426059F1D5A2D);
    LIB_FUNCTION("2o4V3QCvnfg", "libSceNpManager", 1, "libSceNpManager", Func_DA8E15DD00AF9DF8);
    LIB_FUNCTION("24aYdkO7Xdc", "libSceNpManager", 1, "libSceNpManager", Func_DB86987643BB5DD7);
    LIB_FUNCTION("3sU9cWXBN98", "libSceNpManager", 1, "libSceNpManager", Func_DEC53D7165C137DF);
    LIB_FUNCTION("397uJvLrlrM", "libSceNpManager", 1, "libSceNpManager", Func_DFDEEE26F2EB96B3);
    LIB_FUNCTION("4gVqbwFkKGY", "libSceNpManager", 1, "libSceNpManager", Func_E2056A6F01642866);
    LIB_FUNCTION("4kDpuFl+5W4", "libSceNpManager", 1, "libSceNpManager", Func_E240E9B8597EE56E);
    LIB_FUNCTION("4yzjO3BvBfc", "libSceNpManager", 1, "libSceNpManager", Func_E32CE33B706F05F7);
    LIB_FUNCTION("5PZ+-JHIT4c", "libSceNpManager", 1, "libSceNpManager", Func_E4F67EFC91C84F87);
    LIB_FUNCTION("5vBBomYPg+s", "libSceNpManager", 1, "libSceNpManager", Func_E6F041A2660F83EB);
    LIB_FUNCTION("6Xm6QTvYTTg", "libSceNpManager", 1, "libSceNpManager", Func_E979BA413BD84D38);
    LIB_FUNCTION("7d3y0wXbeGY", "libSceNpManager", 1, "libSceNpManager", Func_EDDDF2D305DB7866);
    LIB_FUNCTION("8I7HcltC4vk", "libSceNpManager", 1, "libSceNpManager", Func_F08EC7725B42E2F9);
    LIB_FUNCTION("81ldjv-ybsA", "libSceNpManager", 1, "libSceNpManager", Func_F3595D8EFFF26EC0);
    LIB_FUNCTION("899ScRQvFV0", "libSceNpManager", 1, "libSceNpManager", Func_F3DF5271142F155D);
    LIB_FUNCTION("+JmXFo3Jh6g", "libSceNpManager", 1, "libSceNpManager", Func_F89997168DC987A8);
    LIB_FUNCTION("+RtbJcybMNk", "libSceNpManager", 1, "libSceNpManager", Func_F91B5B25CC9B30D9);
    LIB_FUNCTION("-DNbcQKlhbM", "libSceNpManager", 1, "libSceNpManager", Func_FC335B7102A585B3);
    LIB_FUNCTION("-OrDVMqLIG4", "libSceNpManager", 1, "libSceNpManager", Func_FCEAC354CA8B206E);
    LIB_FUNCTION("-5ZuQ1HlZNY", "libSceNpManager", 1, "libSceNpManager", Func_FF966E4351E564D6);
    LIB_FUNCTION("Ybu6AxV6S0o", "libSceNpManagerIsPlusMember", 1, "libSceNpManager",
                 sceNpIsPlusMember);
    ...
    LIB_FUNCTION("ilwLM4zOmu4", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpGetParentalControlInfo);
    LIB_FUNCTION("F6E4ycq9Dbg", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpGetUserIdByOnlineId);
    LIB_FUNCTION("Vh1bhUG6mSs", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpInGameMessagePrepare);
    LIB_FUNCTION("ON7Sf5XEMmI", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpInGameMessageSendData);
    LIB_FUNCTION("uFJpaKNBAj4", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpRegisterGamePresenceCallback);
    LIB_FUNCTION("VfRSmPmj8Q8", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpRegisterStateCallback);
    LIB_FUNCTION("KO+11cgC7N0", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpSetGamePresenceOnline);
    LIB_FUNCTION("mjjTXh+NHWY", "libSceNpManagerCompat", 1, "libSceNpManager",
                 sceNpUnregisterStateCallback);
