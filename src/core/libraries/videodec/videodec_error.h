...
// Vdecsw library
constexpr int ORBIS_VDECSW_ERROR_API_FAIL = 0x81510100;
constexpr int ORBIS_VDECSW_ERROR_STRUCT_SIZE = 0x81510101;
constexpr int ORBIS_VDECSW_ERROR_ARGUMENT_POINTER = 0x81510102;
constexpr int ORBIS_VDECSW_ERROR_DECODER_INSTANCE = 0x81510103;
constexpr int ORBIS_VDECSW_ERROR_MEMORY_SIZE = 0x81510104;
constexpr int ORBIS_VDECSW_ERROR_MEMORY_POINTER = 0x81510105;
constexpr int ORBIS_VDECSW_ERROR_FRAME_BUFFER_SIZE = 0x81510106;
constexpr int ORBIS_VDECSW_ERROR_FRAME_BUFFER_POINTER = 0x81510107;
constexpr int ORBIS_VDECSW_ERROR_FRAME_BUFFER_ALIGNMENT = 0x81510108;
constexpr int ORBIS_VDECSW_ERROR_NOT_DIRECT_MEMORY = 0x8151010B;
constexpr int ORBIS_VDECSW_ERROR_MEMORY_INFO = 0x8151010C;
constexpr int ORBIS_VDECSW_ERROR_ACCESS_UNIT_SIZE = 0x8151010D;
constexpr int ORBIS_VDECSW_ERROR_ACCESS_UNIT_POINTER = 0x8151010E;
constexpr int ORBIS_VDECSW_ERROR_OUTPUT_INFO = 0x8151010F;
constexpr int ORBIS_VDECSW_ERROR_COMPUTE_QUEUE = 0x81510110;
constexpr int ORBIS_VDECSW_ERROR_FATAL_STATE = 0x81510111;
constexpr int ORBIS_VDECSW_ERROR_PRESET_VALUE = 0x81510112;
constexpr int ORBIS_VDECSW_ERROR_INPUT_QUEUE_FULL = 0x81510113;
constexpr int ORBIS_VDECSW_ERROR_OUTPUT_BUFFER_FULL = 0x81510114;
constexpr int ORBIS_VDECSW_ERROR_OUTPUT_PENDING = 0x81510115;
constexpr int ORBIS_VDECSW_ERROR_INPUT_QUEUE_EMPTY = 0x81510116;
constexpr int ORBIS_VDECSW_ERROR_DECODE_PENDING = 0x81510117;
constexpr int ORBIS_VDECSW_ERROR_OUTPUT_BUFFER_EMPTY = 0x81510118;
constexpr int ORBIS_VDECSW_ERROR_CONFIG_INFO = 0x81510200;
constexpr int ORBIS_VDECSW_ERROR_COMPUTE_PIPE_ID = 0x81510201;
constexpr int ORBIS_VDECSW_ERROR_COMPUTE_QUEUE_ID = 0x81510202;
constexpr int ORBIS_VDECSW_ERROR_RESOURCE_TYPE = 0x81510203;
constexpr int ORBIS_VDECSW_ERROR_CODEC_TYPE = 0x81510204;
constexpr int ORBIS_VDECSW_ERROR_PROFILE_LEVEL = 0x81510205;
constexpr int ORBIS_VDECSW_ERROR_INPUT_QUEUE_DEPTH = 0x81510206;
constexpr int ORBIS_VDECSW_ERROR_AFFINITY_MASK = 0x81510207;
constexpr int ORBIS_VDECSW_ERROR_THREAD_PRIORITY = 0x81510208;
constexpr int ORBIS_VDECSW_ERROR_DPB_FRAME_COUNT = 0x81510209;
constexpr int ORBIS_VDECSW_ERROR_FRAME_WIDTH_HEIGHT = 0x8151020A;
constexpr int ORBIS_VDECSW_ERROR_EXTRA_CONFIG_INFO = 0x8151020B;
constexpr int ORBIS_VDECSW_ERROR_MEMORY_TYPE = 0x8151020C;
constexpr int ORBIS_VDECSW_ERROR_NEW_SEQUENCE = 0x81510300;
constexpr int ORBIS_VDECSW_ERROR_ACCESS_UNIT = 0x81510301;
constexpr int ORBIS_VDECSW_ERROR_OVERSIZE_DECODE = 0x81510302;
constexpr int ORBIS_VDECSW_ERROR_INVALID_SEQUENCE = 0x81510303;
constexpr int ORBIS_VDECSW_ERROR_FATAL_STREAM = 0x81510304;